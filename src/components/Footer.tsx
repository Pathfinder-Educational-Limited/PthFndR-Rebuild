        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-12 lg:gap-8 mb-16">
          ...
          <div className="col-span-1 border-b border-white/10 md:border-none pb-4 md:pb-0">
            ...
            <ul id="footer-programmes-list" className={`space-y-1 md:space-y-3 mt-4 md:mt-0 ${openSection === 'programmes' ? 'block' : 'hidden md:block'}`}>
              ...
              <li><Link to="/programmes/pthfndr-accelerator" className="block py-3 md:py-0 text-sm text-slate-300 hover:text-[#5DC26A] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-pth-green focus:ring-offset-2 focus:ring-offset-[#0C2A5C] rounded px-2 -mx-2 md:px-0 md:mx-0">PthFndR Accelerator</Link></li>
