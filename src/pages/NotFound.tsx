...
export default function NotFound() {
  return (
    <>
      <SEO title="Page Not Found | PthFndR" description="The page you're looking for doesn't exist. Explore PthFndR's programmes, opportunities, and community." noindex={true} />
      <section className="relative bg-pth-warm min-h-[70vh] flex items-center overflow-hidden py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/" className="inline-flex items-center justify-center gap-2 bg-pth-green text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#4ea858] transition-all shadow-lg hover:shadow-xl">
              Back home <ArrowRight size={20} aria-hidden="true" />
            </Link>
            <Link to="/programmes" className="inline-flex items-center justify-center gap-2 border-2 border-pth-navy text-pth-navy px-8 py-4 rounded-xl font-bold text-lg hover:bg-pth-navy hover:text-white transition-all">
              Explore programmes
            </Link>
          </div>
        </div>
