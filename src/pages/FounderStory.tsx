    ...
    <>
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-slate mx-auto space-y-6 text-lg text-slate-700 leading-relaxed">
            <p>
            ...
            <p>The advice wasn't necessarily wrong.</p>
            ...
            <p>That's why we created PthFndR.</p>
            <p>
            ...
            <p>Our ambition is simple: to create better pathways for young people.</p>
            <p>We do that through three stages: Discover, Develop, Deploy.</p>
            ...
            <p>We want them to eventually become pathfinders themselves.</p>
            <p>To find their way.</p>
            <p>To create new possibilities.</p>
            <p>And, just as importantly, to take others with them.</p>
            <p>That is the PthFndR idea.</p>
            <p>We aren't here simply to tell young people where the jobs are.</p>
            <p>
